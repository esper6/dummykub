...
@onready var master_slider: HSlider = $VBoxContainer/MasterVolumeContainer/Slider
@onready var master_label: Label = $VBoxContainer/MasterVolumeContainer/ValueLabel
@onready var sfx_slider: HSlider = $VBoxContainer/SFXVolumeContainer/Slider
@onready var sfx_label: Label = $VBoxContainer/SFXVolumeContainer/ValueLabel
@onready var music_slider: HSlider = $VBoxContainer/MusicVolumeContainer/Slider
@onready var music_label: Label = $VBoxContainer/MusicVolumeContainer/ValueLabel
